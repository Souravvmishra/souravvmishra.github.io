...
export const GithubButton = () => {
        ...
        >
            <motion.div className="flex items-center gap-3">
                <motion.img
                    ...
                    alt="GitHub Profile of Sourav Mishra"
    ...
    return <SocialButton
        ...
        label="GitHub Profile of Sourav Mishra"
        preview={preview}
    />
}
...
export const LinkedInButton = () => (
    <SocialButton
        ...
        label="LinkedIn Profile of Sourav Mishra"
...
export const TwitterButton = () => (
    <SocialButton
        ...
        label="Follow Sourav Mishra on X"
