        ...
        <main className="flex flex-col items-center justify-center min-h-screen bg-background">
            ...
            >
                <motion.img
                    ...
                    alt="Sourav Mishra - Product Designer and Visual Developer"
                ...
                >
                    {staggerWords("Hi, I'm Sourav Mishra")} <span aria-hidden="true">✌️</span>
                </motion.h1>
                <motion.h2 
                    variants={itemVariants}
                ...
                >
                    {staggerWords("a Product Designer and Visual Developer in Jammu, India. I specialize in UI/UX Design, Responsive Web Design, and Visual Development.")}
                </motion.p>
